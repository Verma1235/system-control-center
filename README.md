...
**Live Preview:** [Systems Control Panel](#) _(Insert actual link if deployed)_
...
## 🔏 System Agent (code/setup) to buid desktop app

Read working/fetures and setup of [system-agent](https://github.com/Verma1235/system-agent), working with [system-control-center](https://github.com/Verma1235/system-control-center).
